...
class EditarServicioWidget extends StatefulWidget {
  ...
  final ServiciosRecord? servicioEditar;
...
class _EditarServicioWidgetState extends State<EditarServicioWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.servicioEditar?.nombre);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: widget.servicioEditar?.descripcion);
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??=
        TextEditingController(text: widget.servicioEditar?.precio.toString());
                  ...
                  children: [
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        ...
                        FFAppState().servicioEditar = null;
                        safeSetState(() {});
                        Navigator.pop(context);
                      },
                      text: FFLocalizations.of(context).getText(
                        'mkuyx3s5' /* Guardar Cambios */,
                      ),
                      options: FFButtonOptions(
                        width: 150.0,
                        height: 48.0,
