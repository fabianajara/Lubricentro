...
class EditarProductoWidget extends StatefulWidget {
  const EditarProductoWidget({
    super.key,
    required this.productoEditar,
  });

  final ProductosRecord? productoEditar;
...
class _EditarProductoWidgetState extends State<EditarProductoWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??=
        TextEditingController(text: widget.productoEditar?.nombre);
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??=
        TextEditingController(text: widget.productoEditar?.descripcion);
                          ...
                          child: Column(
                            ...
                            children: [
                              TextFormField(
                                ...
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: widget.productoEditar?.precio
                                      .toString(),
                          ...
                          child: Column(
                            ...
                            children: [
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  labelText:
                                      widget.productoEditar?.stock.toString(),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodyLarge
                                      .override(
                                        font: GoogleFonts.inter(
                          ...
                          child: StreamBuilder<List<CategoriasRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              List<CategoriasRecord>
                                  dropDownCategoriaEditarCategoriasRecordList =
                                  snapshot.data!;

                              return FlutterFlowDropDown<String>(
                                controller: _model
                                        .dropDownCategoriaEditarValueController ??=
                                ...
                                onChanged: (val) async {
                                  safeSetState(() => _model
                                      .dropDownCategoriaEditarValue = val);
                                  _model.queryCategoriaEditar =
                                      await queryCategoriasRecordOnce(
                                    queryBuilder: (categoriasRecord) =>
                                        categoriasRecord.where(
                                      'nombre',
                                      isEqualTo:
                                          _model.dropDownCategoriaEditarValue,
                                    ),
                                    singleRecord: true,
                                  ).then((s) => s.firstOrNull);
                                  FFAppState().categoriasElegida =
                                      _model.queryCategoriaEditar?.reference;
                                  safeSetState(() {});
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        if (_model.uploadedFileUrl != '') {
                          await widget.productoEditar!.reference
                            ...
                            categoriaRef: FFAppState().categoriasElegida,
                            stock: int.tryParse(_model.textController4.text),
                        ...
                        FFAppState().categoriasElegida = null;
                        FFAppState().productoEditar = null;
                        safeSetState(() {});
                        Navigator.pop(context);
                      },
                      text: FFLocalizations.of(context).getText(
                        'w42ekoft' /* Guardar Cambios */,
                      ),
                      options: FFButtonOptions(
                        width: 150.0,
                        height: 48.0,
