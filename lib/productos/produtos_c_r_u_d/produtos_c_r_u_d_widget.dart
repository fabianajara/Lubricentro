...
import '/productos/editar_producto/editar_producto_widget.dart';
import '/index.dart';
...
import 'produtos_c_r_u_d_model.dart';
export 'produtos_c_r_u_d_model.dart';

class ProdutosCRUDWidget extends StatefulWidget {
  const ProdutosCRUDWidget({
    super.key,
    this.categoriaElegida,
    this.idCategoriaElegida,
  });

  final DocumentReference? categoriaElegida;
  final String? idCategoriaElegida;

  static String routeName = 'ProdutosCRUD';
  static String routePath = '/produtosCRUD';

  @override
  State<ProdutosCRUDWidget> createState() => _ProdutosCRUDWidgetState();
}

class _ProdutosCRUDWidgetState extends State<ProdutosCRUDWidget>
    with TickerProviderStateMixin {
  late ProdutosCRUDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProdutosCRUDModel());
                                                      ...
                                                      Hero(
                                                        tag: valueOrDefault<
                                                          ...
                                                          listViewProductosRecord
                                                              .imagenUrl,
                                                          'https://baskiofisi.com.tr/wp-content/uploads/default-image-1.jpg' +
                                                              '$listViewIndex',
                                                        ),
