...
class LoginModel extends FlutterFlowModel<LoginWidget> {
  ...
  String? _passwordCreateTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'op4cjvut' /* Contraseña  es requerido */,
      );
    }
  ...
  String? _rEpasswordCreateTextControllerValidator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '6uh20f2l' /* Contraseña es requerido */,
      );
    }
  ...
  String? _telefonoTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '37dd57c0' /* Teléfono es requerido */,
      );
    }
  ...
  void initState(BuildContext context) {
    ...
    rEpasswordCreateTextControllerValidator =
        _rEpasswordCreateTextControllerValidator;
